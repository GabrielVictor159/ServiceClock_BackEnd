...
public class GetCompanyById : UseCaseCore
{
    ...
    [OpenApiOperation(operationId: "GetCompanyById", tags: new[] { "GetCompanyById" })]
    ...
    [OpenApiResponseWithBody(statusCode: HttpStatusCode.BadRequest, contentType: "application/json", bodyType: typeof(string), Description = "The Bad Request response in case of invalid input.")]//Arrumar
